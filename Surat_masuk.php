...
class Surat_masuk extends ResourceController
{
    protected $helpers = ['Notify_helper'];

    protected $modelName = 'App\Models\Surat_masukModel';
    ...
    public function create()
    {
        ...
        $data = [
            ...
            'tgl_doing' => $this->request->getPost('tgl_doing'),
            ...
            'bu_kpd' => $this->request->getPost('bu_kpd'),
            'bu_kdmslh' => $this->request->getPost('bu_kdmslh'),
            'bu_sekpri' => $this->request->getPost('bu_sekpri'),
            'bu_disediakan' => $this->request->getPost('bu_disediakan'),
                ...
                $simpan = $this->model->updateSurat($data,$id);
                    if($simpan){
                        ...
                        $response = [
                            ...
                            //gettoken
                            $token = $this->model->getToken("160008");
                            $b = $token['token'];
                            notify($b);
                            //end Notifikasi Trigger 
                    }

...
class Sm_Workflow extends ResourceController
{
    protected $helpers = ['Notify_helper'];

    protected $modelName = 'App\Models\Sm_Workflowmodel';
    ...
    public function create()
    {
        ...
        $data = [
            "id_smwf" => $this->request->getPost('id_smwf'),
    ...
    public function update($id = null)
    {
        if($id==null)
        {
            ...
            $find = $this->model->getWhere(['id_smwf' => $id])->getResult();
            if($find)
            {
    ...
    public function delete($id = null)
    {
        ...
        {
            $data = $this->model->getWhere(['id_smwf' => $id])->getResult();
            if($data){
